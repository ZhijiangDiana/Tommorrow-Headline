...
public class MongoTest {
    ...
    public void saveTest(){
        for (int i = 0; i < 10; i++) {
            ...
            apAssociateWords.setAssociateWords("山里灵活");
    ...
    public void testQuery(){
        Query query = Query.query(Criteria.where("associateWords").is("山里灵活"))
    ...
    @Test
    public void testDel(){
        mongoTemplate.remove(Query.query(Criteria.where("associateWords").is("山里灵活")),ApAssociateWords.class);
    }
}
