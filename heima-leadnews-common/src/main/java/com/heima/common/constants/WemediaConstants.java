 ...
 * @Description
 * @Author 嘉然今天吃向晚
 * @Date 2024/12/26-21:23:01
 */
public class WemediaConstants {

    // 图片0
    public static final Short WM_MATERIAL_PIC = 0;
    // 视频1
    public static final Short WM_MATERIAL_VID = 1;
    ...
    public static final Short WM_NEWS_RELEASED = 1;  // 已上架
    public static final Short WM_NEWS_PULLED_DOWN = 0;  // 已下架
}
